...
export function generatePasswordResetEmail(data: PasswordResetEmailData): {
  ...
  return {
    subject: "Reset your password — TenantForge",
    html: `
      <!DOCTYPE html>
      <html lang="en">
      <head>
                ...
                <tr>
                  <td style="padding: 0 40px 40px;">
                    <p style="margin: 0 0 16px; color: #374151; font-size: 16px; line-height: 1.5;">
                      We received a request to reset your TenantForge password. Click the button below to choose a new one.
                    </p>
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      <tr>
                        <td align="center" style="padding: 8px 0;">
                          <a href="${resetUrl}" style="display: inline-block; padding: 12px 32px; background-color: #10B981; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                            Reset Password
                          </a>
                        </td>
                      </tr>
